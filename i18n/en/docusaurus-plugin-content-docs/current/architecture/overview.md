...
A web application your IT administrators use to manage the fleet.

### Agent (client software)

A lightweight Windows Service installed on each managed machine. The agent **always initiates** the connection — the server never connects to machines directly.
